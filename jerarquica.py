...
faq_worker = Agent(name="FAQWorker", instructions="Responde mediante la base de FAQs.", tools=[FAQ_TOOL], model=MODEL, model_settings=SETTINGS)
...
if __name__ == "__main__":
    print(run_agent(root_manager, " ".join(sys.argv[1:]) or input("Consulta: ")))
